...
trait NumericBaseMatchers {
  /** matches if x <= n */
  def beLessThanOrEqualTo[S](n: S)(implicit ev: S => Ordered[S]) = new BeLessThanOrEqualTo(n)
  /** matches if x <= n */
  def lessThanOrEqualTo[S](n: S)(implicit ev: S => Ordered[S]) = beLessThanOrEqualTo(n)
  /** alias for beLessThanOrEqualTo */
  def be_<=[S](n: S)(implicit ev: S => Ordered[S]) = beLessThanOrEqualTo(n)
  /** alias for beLessThanOrEqualTo */
  def <=[S](n: S)(implicit ev: S => Ordered[S]) = beLessThanOrEqualTo(n)
  /** matches if x < n */
  def beLessThan[S](n: S)(implicit ev: S => Ordered[S]) = new BeLessThan(n)
  def lessThan[S](n: S)(implicit ev: S => Ordered[S]) = beLessThan(n)
  /** alias for beLessThan */
  def be_<[S](n: S)(implicit ev: S => Ordered[S]) = beLessThan(n)
  /** alias for beLessThan */
  def <[S](n: S)(implicit ev: S => Ordered[S]) = beLessThan(n)
  /** matches if x >= n */
  def beGreaterThanOrEqualTo[S](n: S)(implicit ev: S => Ordered[S]) = new BeLessThan(n).not
  def greaterThanOrEqualTo[S](n: S)(implicit ev: S => Ordered[S]) = beGreaterThanOrEqualTo(n)
  /** alias for beGreaterThanOrEqualTo */
  def be_>=[S](n: S)(implicit ev: S => Ordered[S]) = beGreaterThanOrEqualTo(n)
  /** alias for beGreaterThanOrEqualTo */
  def >=[S](n: S)(implicit ev: S => Ordered[S]) = beGreaterThanOrEqualTo(n)
  /** matches if x > n */
  def beGreaterThan[S](n: S)(implicit ev: S => Ordered[S]) = new BeLessThanOrEqualTo(n).not
  def greaterThan[S](n: S)(implicit ev: S => Ordered[S]) = beGreaterThan(n)
  /** alias for beGreaterThan */
  def be_>[S](n: S)(implicit ev: S => Ordered[S]) = beGreaterThan(n)
  /** alias for beGreaterThan */
  def >[S](n: S)(implicit ev: S => Ordered[S]) = beGreaterThan(n)
  ...
  def beBetween[T](t1: T, t2: T)(implicit ev: T => Ordered[T]): BetweenMatcher[T] = BetweenMatcher(t1, t2)
  def between[T](t1: T, t2: T)(implicit ev: T => Ordered[T]): BetweenMatcher[T] = BetweenMatcher(t1, t2)

  /** alias for the adventurous: 5 must (`be[(2, 7)`[`) */
  def `be[`[T](t1: T, t2: T)(implicit ev: T => Ordered[T]): BetweenMatcher[T] = BetweenMatcher(t1, t2)
  /** alias for the adventurous: 5 must (`be](2, 7)`[`) */
  def `be]`[T](t1: T, t2: T)(implicit ev: T => Ordered[T]): BetweenMatcher[T] = BetweenMatcher(t1, t2).excludingStart
}
...
trait NumericBeHaveMatchers extends BeHaveMatchers { outer: NumericBaseMatchers =>
  ...
  implicit def toOrderedResultMatcher[S](result: MatchResult[S])(implicit ev: S => Ordered[S]): OrderedResultMatcher[S] = new OrderedResultMatcher(result)
  class OrderedResultMatcher[S](result: MatchResult[S])(implicit ev: S => Ordered[S]) {
  ...
  class NeutralMatcherOrdered(result: NeutralMatcher[Any]) {
    def <=[S](n: S)(implicit ev: S => Ordered[S])    = outer.beLessThanOrEqualTo(n)
    def <[S](n: S)(implicit ev: S => Ordered[S])     = outer.beLessThan(n)
    def >=[S](n: S)(implicit ev: S => Ordered[S])    = outer.beGreaterThanOrEqualTo(n)
    def >[S](n: S)(implicit ev: S => Ordered[S])     = outer.beGreaterThan(n)
  }
...
class BeLessThanOrEqualTo[T](n: T)(implicit ev: T => Ordered[T]) extends Matcher[T] {
...
class BeLessThan[T](n: T)(implicit ev: T => Ordered[T]) extends Matcher[T] {
  def apply[S <: T](a: Expectable[S]) = {
    val r = a.value < n
    result(r,
...
case class BetweenMatcher[T](t1: T, t2: T, includeStart: Boolean = true, includeEnd: Boolean = true)(implicit ev: T => Ordered[T]) extends Matcher[T] {
